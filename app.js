...
const PRODUCTS = [
  { name:"My Way", category:"femme", img:"images/1.jpeg" },
  { name:"Alien", category:"femme", img:"images/2.jpeg" },
  { name:"Prada Paradoxe", category:"femme", img:"images/3.jpeg" },
  { name:"Baccarat Rouge", category:"femme", img:"images/4.jpeg" },
  ...
  { name:"Dareej", category:"homme", img:"images/8.jpeg" },
  ...
  { name:"K Dolce Gabbana", category:"homme", img:"images/17.jpeg" },
  { name:"Alien Purple", category:"femme", img:"images/18.jpeg" },
...
function displayProducts(list){
  container.innerHTML="";
  list.forEach(p=>{
    const msg=`Je veux commander ${p.name} ${SIZE} ${PRICE}`;
    container.innerHTML+=`
      <div class="card">
        <img src="${p.img}">
        <h2>${p.name}</h2>
